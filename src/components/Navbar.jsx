...
const Navbar = () => {
  ...
  const linkClass = ({ isActive }) =>
    `relative nav-link text-slate-300 transition duration-300 hover:text-cyan-400 ${
      ...
      after:left-1/2 after:-translate-x-1/2 after:-bottom-1 after:transition-all
    ...
    <>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button
                ...
                className="nav-link text-slate-300 hover:text-cyan-400 transition duration-300 relative after:content-[''] after:absolute after:w-0 after:h-[2px] after:bg-cyan-400 after:left-1/2 after:-translate-x-1/2 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full"
              >
                About
              </button>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-6">
          <NavLink to="/home" onClick={() => setIsOpen(false)} className="text-4xl font-bold text-slate-300 hover:text-cyan-300 transition duration-300">
            Home
          </NavLink>
          <button onClick={handleAboutClick} className="text-4xl font-bold text-slate-300 hover:text-cyan-300 transition duration-300">
            About
          </button>
          <NavLink to="/events" onClick={() => setIsOpen(false)} className="text-4xl font-bold text-slate-300 hover:text-cyan-300 transition duration-300">
            Events
          </NavLink>
          <NavLink to="/faqs" onClick={() => setIsOpen(false)} className="text-4xl font-bold text-slate-300 hover:text-cyan-300 transition duration-300">
            FAQs
          </NavLink>
          <a
            href="https://forms.gle/mU88yw64QHCMLn4GA"
