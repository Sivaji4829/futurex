        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <NavLink to="/home" className="flex-shrink-0">
              <span
                className="
                  relative text-3xl font-extrabold tracking-wider font-orbitron 
                  text-white drop-shadow-[0_0_8px_#22d3ee] 
                  transition-transform duration-300 
                  hover:scale-110 hover:drop-shadow-[0_0_18px_#a855f7]
                "
              >
                Future X
              </span>
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                className={`relative w-12 h-12 flex items-center justify-center rounded-full border-2 border-cyan-400 transition-all duration-500 
                  ${
                    isOpen
                      ? "rotate-180 border-purple-400 shadow-[0_0_12px_#a855f7]"
                      : "hover:rotate-90 hover:shadow-[0_0_8px_#22d3ee]"
                  }`}
              >
                <span
